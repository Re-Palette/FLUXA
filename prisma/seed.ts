/* Seeds global catalog data: AI employee templates, plans, model prices. Idempotent. */
...
async function main() {
  ...
  console.log(`Seeded ${EMPLOYEE_TEMPLATES.length} employee templates, ${PLANS.length} plans, ${MODEL_PRICES.length} model prices.`);
}
